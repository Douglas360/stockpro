/*
  ...
  - Added the required column `venda` to the `t_pagamento` table without a default value. This is not possible if the table is not empty.
...
-- AlterTable
ALTER TABLE [dbo].[t_pagamento] ADD [venda] BIT NOT NULL;
