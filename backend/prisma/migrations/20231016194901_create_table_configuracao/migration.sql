...
CREATE TABLE [dbo].[Configuracao] (
    [id_configuracao] INT NOT NULL IDENTITY(1,1),
    [id_empresa] INT NOT NULL,
    [periodo_validade_produto] NVARCHAR(1000),
    [permite_venda_produto_sem_estoque] BIT,
    [permite_atualizacao_valor_orcamento] BIT,
    CONSTRAINT [Configuracao_pkey] PRIMARY KEY CLUSTERED ([id_configuracao])
);
