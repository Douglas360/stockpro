...
-- CreateTable
CREATE TABLE [dbo].[t_foto_produto] (
    [id_foto_produto] INT NOT NULL IDENTITY(1,1),
    [id_produto] INT NOT NULL,
    [caminho] NVARCHAR(1000),
    CONSTRAINT [t_foto_produto_pkey] PRIMARY KEY CLUSTERED ([id_foto_produto])
);

-- AddForeignKey
ALTER TABLE [dbo].[t_foto_produto] ADD CONSTRAINT [t_foto_produto_id_produto_fkey] FOREIGN KEY ([id_produto]) REFERENCES [dbo].[t_produto]([id_produto]) ON DELETE CASCADE ON UPDATE CASCADE;
