...
export const RelatorioFornecedor = (data) => {
    const docDefinition = {
        pageSize: 'A4',
...

            {
                table: {
                    ...
                    body: [
                        [
                            {
                                text: 'Relatórios de Cadastros - Fornecedores',
                                fontSize: 16,
                                bold: true,
                ...
                table: {
                    ...
                    body: [
                        [
                            { text: 'ID', bold: true },
                            { text: 'Nome', bold: true },
                            { text: 'Tipo Fornecedor', bold: true },
                            { text: 'CNPJ', bold: true },
                        ...
                        ...(data || []).map((item) => [
                            { text: item.id_fornecedor, fontSize: 10 }, // Adjust the font size if needed
                            { text: item.nome, fontSize: 10 }, // Adjust the font size if needed
                            { text: item.tipo_fornecedor, fontSize: 10 }, // Adjust the font size if needed
