...
import { RelatorioTransportadora } from '../../../reports/Cadastro/RelatorioTransportadora'

export const Transportadora = () => {
    const { user } = useAuth()
    const { getReportCarriers, loading } = useReport()
    const handleSubmit = async (e) => {
        ...
        const response = await getReportCarriers(data)
        if (response) {
            RelatorioTransportadora(response)
        }
    }
    return (
        <>
            <PageTitle
                heading={'Relatório de Transportadora'}
                subheading="Relatório de Transportadora"
