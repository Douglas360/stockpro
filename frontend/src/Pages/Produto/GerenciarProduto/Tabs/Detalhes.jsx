...
export const Detalhes = ({
  ...
  const handleFieldChange = (index, field, value) => {
    ...
    handleInputChange({
      target: { name: "camposExtras", value: updatedFields },
    });
  };
    ...
    <Card className="main-card mb-3">
      ...
      <CardBody>
        <Form onSubmit={handleSubmit}>
          ...
          <Row className="mb-3">
            <Col md="5">
              <Label for="pesoProduto" style={{ fontWeight: "bold" }}>
                Peso (kg)
              </Label>
              ...
              <NumericFormat
                ...
                onChange={(e) =>
                  handleInputChange({
                    target: {
                      name: "pesoProduto",
                      value: String(cleanCurrencyMask(e.target.value)),
                    },
                  })
                }
              />

              <Label for="alturaProduto" style={{ fontWeight: "bold" }}>
                Altura (cm)
              </Label>
              ...
              <Label for="larguraProduto" style={{ fontWeight: "bold" }}>
                Largura (cm)
              </Label>
              ...
              <Label for="comprimentoProduto" style={{ fontWeight: "bold" }}>
                Comprimento (cm)
              </Label>
              <NumericFormat
                className="form-control"
            ...
            <Col md="7">
              <Alert color="info" isOpen={alert} toggle={handleAlert}>
                <FontAwesomeIcon
                  ...
                  style={{ fontSize: 20, marginRight: 3 }}
                />
                Você pode definir alguns campos extras para este produto como
                uma marca, modelo e etc... Ex: Marca - Adidas.
              </Alert>
                    ...
                    <tr key={index}>
                      ...
                      <td>
                        <Input
                          ...
                          onChange={(e) =>
                            handleFieldChange(index, "conteudo", e.target.value)
                          }
                        />
                      </td>
