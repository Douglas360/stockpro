...
import { Alert, Button, Card, CardBody, Col, Form, Input, InputGroup, Label, Row, Tooltip } from 'reactstrap';
...
export const Dados = ({ data, handleInputChange, handleSubmit, Loading }) => {
  ...
  const handleCodigoInternoChange = (e) => {
    const { value } = e.target;
    setCodigoInterno(value);

    // Update the data object
    handleInputChange({ target: { name: 'codigoInterno', value: value } });
  };
    ...
    <Card className="main-card mb-3">
      ...
      <CardBody>
        ...
        <Form onSubmit={handleSubmit}>
          <Row className="mb-2">
            <Col md={3}>
              <Label for="nomeProduto" style={{ fontWeight: 'bold' }}>
                Nome do produto
              </Label>{' '}
              ...
              <Tooltip
                placement="top"
                isOpen={tooltipOpen['infProduto']}
                target="infProduto"
                toggle={() => toggle('infProduto')}
            ...
            <Col md={3}>
              <Label for="codigoInterno" style={{ fontWeight: 'bold' }}>
                Código interno
              </Label>{' '}
              <span className="text-danger">* </span>
              <FontAwesomeIcon
              ...
              <Tooltip
                placement="top"
                isOpen={tooltipOpen['infCodigo']}
                target="infCodigo"
                toggle={() => toggle('infCodigo')}
                style={{ fontSize: '.7rem', padding: '4px 8px' }}
              >
              ...
              <InputGroup>
                <Input
                  ...
                  value={codigoInterno}
                  onChange={handleCodigoInternoChange}
            ...
            <Col md={3}>
              <Label for="codigoBarra" style={{ fontWeight: 'bold', marginRight: 3 }}>
                Código de barra
              </Label>
              <FontAwesomeIcon
                icon={faExclamationCircle}
              ...
              <Tooltip
                placement="top"
                isOpen={tooltipOpen['infCodigoBarra']}
                target="infCodigoBarra"
                toggle={() => toggle('infCodigoBarra')}
                style={{ fontSize: '.7rem', padding: '4px 8px' }}
              >
            ...
            <Col md={3}>
              <Label for="movimentaEstoque" style={{ fontWeight: 'bold', marginRight: 3 }}>
                Movimenta estoque?
              </Label>
              <FontAwesomeIcon
                icon={faExclamationCircle}
                size="sm"
                style={{ cursor: 'pointer' }}
                id="infMovimentaEstoque"
                name="infMovimentaEstoque"
              />
              <Tooltip
                placement="top"
                isOpen={tooltipOpen['infMovimentaEstoque']}
                target="infMovimentaEstoque"
                toggle={() => toggle('infMovimentaEstoque')}
                style={{ fontSize: '.7rem', padding: '4px 8px' }}
              >
          ...
          <Row className="mb-2">
            <Col md={3}>
              <Label for="habilitarNf" style={{ fontWeight: 'bold', marginRight: 3 }}>
              ...
              <Tooltip
                placement="top"
                isOpen={tooltipOpen['infHabilitarNf']}
                target="infHabilitarNf"
                toggle={() => toggle('infHabilitarNf')}
                style={{ fontSize: '.7rem', padding: '4px 8px' }}
              >
            ...
            <Col md={3}>
              <Label for="validade" style={{ fontWeight: 'bold', marginRight: 3 }}>
                Possui validade?
              </Label>
              <FontAwesomeIcon
                icon={faExclamationCircle}
              ...
              <Tooltip
                placement="top"
                isOpen={tooltipOpen['infValidade']}
                target="infValidade"
                toggle={() => toggle('infValidade')}
                style={{ fontSize: '.7rem', padding: '4px 8px' }}
              >
